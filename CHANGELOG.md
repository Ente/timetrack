...
* You can now set different types of worktimes. You can specify your own ones in the `app/v1/inc/configs/worktime_types.json` file. If none is set, like when using the easymode, mode `0` will be used. Added `Wtype` parameter to `WorktimeAdded` event.
