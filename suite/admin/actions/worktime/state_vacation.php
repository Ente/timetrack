...
require "../../../../api/v1/class/auth/plugins/mail_vacation_rejected.auth.arbeit.inc.php";
require "../../../../api/v1/class/auth/plugins/mail_vacation_pending.auth.arbeit.inc.php";
require "../../../../api/v1/class/auth/plugins/mail_vacation_approved.auth.arbeit.inc.php";
session_start();
