...
if(!$work){
    header("Location: http://{$base_url}/suite/?" . $worktime->statusMessages()->URIBuilder('error_worktime'));
} else {
    header("Location: http://{$base_url}/suite/?" . $worktime->statusMessages()->URIBuilder('worktime_added'));
}
